let canvas = document.getElementById('stage');
  ...
  if(value=="1"){
    ...
    const imageUrl = `https://iili.io/d00pha2.md.png`;
  ...
  if(value=="2"){
    ...
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://iili.io/d00pV44.jpg`;
    const hoverUrl = "https://iili.io/HU2qBsI.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if(value=="3"){
    ...
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://iili.io/d00pX3l.md.png`;
    const hoverUrl = "https://iili.io/HU2qBsI.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if(value=="4"){
    ...
    const myImage = document.getElementById("myImage");
    const imageUrl = `https://iili.io/d013WxI.jpg`;
    const hoverUrl = "https://iili.io/HU2qBsI.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
